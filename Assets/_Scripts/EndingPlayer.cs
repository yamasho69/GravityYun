...
public class EndingPlayer: MonoBehaviour
{
    ...
    IEnumerator EndGame() {
        ...
        text.text = serifu;
        gm.RandomizeSfx(secondVoices);
        yield return new WaitForSeconds(3.6f);
        transform.DOMoveX(4, 3.6f);
        fukidashi.SetActive(false);
        transform.DOMoveX(8, 6.0f);
        gm.RandomizeSfx(startVoices);
        yield return new WaitForSeconds(6.0f);
        gm.RandomizeSfx(thirdVoices);
        transform.DOMoveX(11, 2.0f);
